...
(cl:defmethod cl:initialize-instance :after ((m <Dofs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Dofs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name color_sort-msg:<Dofs> is deprecated: use color_sort-msg:Dofs instead.")))

(cl:ensure-generic-function 'base-val :lambda-list '(m))
(cl:defmethod base-val ((m <Dofs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader color_sort-msg:base-val is deprecated.  Use color_sort-msg:base instead.")
  (base m))

(cl:ensure-generic-function 'bs_to_f-val :lambda-list '(m))
(cl:defmethod bs_to_f-val ((m <Dofs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader color_sort-msg:bs_to_f-val is deprecated.  Use color_sort-msg:bs_to_f instead.")
  (bs_to_f m))

(cl:ensure-generic-function 'f_to_s-val :lambda-list '(m))
(cl:defmethod f_to_s-val ((m <Dofs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader color_sort-msg:f_to_s-val is deprecated.  Use color_sort-msg:f_to_s instead.")
  (f_to_s m))

(cl:ensure-generic-function 's_to_thrd-val :lambda-list '(m))
(cl:defmethod s_to_thrd-val ((m <Dofs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader color_sort-msg:s_to_thrd-val is deprecated.  Use color_sort-msg:s_to_thrd instead.")
  (s_to_thrd m))

(cl:ensure-generic-function 'claws-val :lambda-list '(m))
(cl:defmethod claws-val ((m <Dofs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader color_sort-msg:claws-val is deprecated.  Use color_sort-msg:claws instead.")
  (claws m))
